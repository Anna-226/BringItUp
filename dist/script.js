...
window.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  new _modules_differences__WEBPACK_IMPORTED_MODULE_3__["default"]('.officerold', '.officernew', '.officer__card-item').init();
  new _modules_forms__WEBPACK_IMPORTED_MODULE_4__["default"]().requestForm();
});
...
/*#__PURE__*/
function () {
  function Differences(oldOfficer, newOfficer, items) {
...
function () {
  function Forms() {
    ...
    this.forms = document.querySelectorAll('form'); //this.btns = this.form.querySelectorAll(btn);
  }
    ...
    value: function requestForm() {
      this.forms.forEach(function (form) {
        form.addEventListener('submit', function (e) {
          ...
          Object(_services_requests__WEBPACK_IMPORTED_MODULE_1__["postData"])('../../assets/server.php', formData).then(function (res) {
            console.log(res);
          });
        });
      });
...
function () {
  function VideoPlayer(triggers, overlay) {
    ...
    this.btns = document.querySelectorAll(triggers), this.window = document.querySelector(overlay), this.close = document.querySelector('.close');
  }
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          if (document.querySelector('iframe#frame')) {
            _this.window.style.display = 'flex';
          } else {
